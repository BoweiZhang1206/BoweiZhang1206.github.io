...
socialMedia.then(function(data) {
    ...
    // Group data by AgeGroup and compute the quantiles (min, q1, median, q3, max) for each group
    const quantilesByGroups = d3.rollup(data, rollupFunction, d => d.AgeGroup);

    // For each AgeGroup, draw a boxplot using its calculated quantile values
